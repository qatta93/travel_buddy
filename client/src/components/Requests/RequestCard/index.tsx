    ...
    <article className={`request-card request-card--${status}`}>
      <header className={`request-card__header request-card__header--${status}`}>
        <div className="request-card__wrapper">
          ...
          {status === 'accepted' ? (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 request-card__cancel" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          {status === 'pending' ? (
            ...
            : null}
          {status === 'rejected' ? (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 request-card__delete" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
